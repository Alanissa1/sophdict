...
(function() {
    ...
    const handleRouting = () => {
        ...
        if (path.startsWith('570academic') || path.startsWith('listname/') || path.startsWith('llistname/') || path.startsWith('statistics_page') || path === 'feedbackandsupport' || path.includes('/cardsgame')) return;
