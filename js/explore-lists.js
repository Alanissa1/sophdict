    ...
    renderSetting(currentValue = 'link', isNew = true) {
        ...
        return `
            <div class="input-group" style="margin-top: 15px;">
                ...
                <div style="display: flex; gap: 20px; margin-top: 10px; color: var(--text-main);">
                    <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                        <input type="radio" name="${nameAttr}" value="public" ${currentValue === 'public' ? 'checked' : ''}> Public
                    </label>
                    <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                        <input type="radio" name="${nameAttr}" value="link" ${currentValue !== 'public' ? 'checked' : ''}> Just URL
                    </label>
                </div>
            </div>
        `;
